...
#ifndef BOOST_LOCALE_MO_HASH_HPP
...
struct pj_winberger_hash {
  ...
  static state_type update_state(state_type value, const char* begin,
                                 const char* end)
  {
    while (begin != end)
...
pj_winberger_hash_function(const char* begin, const char* end)
{
  pj_winberger_hash::state_type state = pj_winberger_hash::initial_state;
